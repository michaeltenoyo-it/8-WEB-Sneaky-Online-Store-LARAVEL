...
<body >
    ...
    <!-- isi -->
    <div class="form-login-container" style="background-image: url(/assets/images/bgimage/buat_loginnya.png)">
        <div class="block-form-login">
            ...
            <form action="/handleLogin" method="POST">
                ...
                <div class="forget-password">
                    <a href="#" style="text-decoration: none;color: #17293b;">Forget Password?</a>
                </div>
